...
describe "regiments/new.html.erb" do
  before(:each) do
    assign(:regiment, stub_model(Regiment,
      :ordinal => "MyString",
      :volunteer => false,
      :state => "MyString",
      :reg_type => "MyString",
  ...
  it "renders new regiment form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => regiments_path, :method => "post" do
